                            ...
                            @if ($subcategories->isNotEmpty())
                                ...
                                @foreach ($subcategories as $item)
                                    <tr>
                                        <td>{{ $counter++ }}</td>
                                        {{-- <td>{{ $item->id }}</td> --}}
                                        <td>{{ $item->cat_sub_name }}</td>
                                        <td>{{ $item->categoryName }}</td>
                                        <td>{{ $item->cat_sub_slug }}</td>
                                        <td>
                                            @if (!empty($item->cat_sub_image))
                                                <img src="{{ asset('/uploads/subcategory/' . $item->cat_sub_image) }}"
