                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control"
                                        placeholder="Home Slider Name" value="{{ $homeslider->title}}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="homesliders_status" id="homesliders_status" class="form-control">
                                        <option {{ ($homeslider->homesliders_status == '1' ) ? 'selected' : '' }} value="1">Active</option>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="summernote"
                                        placeholder="Description" >{{ $homeslider->description}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                ...
                                <div>
                                    <img width="200" src="{{ asset('uploads/homeslider/'.$homeslider->image) }}" alt="">
                                </div>
...
<script>
    $("#homeSliderform").submit(function(event) {
        ...
        $.ajax({
            url: '{{ route('home-slider.update', $homeslider->id) }}',
            type: 'put',
